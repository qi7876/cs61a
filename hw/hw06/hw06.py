...
class VendingMachine:
    ...
    def restock(self, n: int):
        ...
        "*** YOUR CODE HERE ***"
        self.stock += n            
        msg = f"Current {self.product} stock: {self.stock}"
        return msg
    ...
    def vend(self):
        ...
        "*** YOUR CODE HERE ***"
        if self.stock == 0:
            msg = "Nothing left to vend. Please restock."
            ...
            if self.balance == 0:
                ...
                msg = f"Here is your {self.product} and ${self.balance} change."
            self.balance = 0
...
def store_digits(n: int):
    ...
    """
    "*** YOUR CODE HERE ***"
    last_node: Link | None = None
    while n > 0:
        last_digit = n % 10
        n = n // 10
        curr_node = Link(last_digit)
        if last_node is not None:
            curr_node.rest = last_node
        last_node = curr_node
    return last_node



def deep_map_mut(func, s: "Link"):
